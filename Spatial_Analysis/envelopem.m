...
for k=1:length(A)
    ...
    Exist_lo = strcmp('lo',A{k}{1}.Properties.VariableNames);
    Exist_hi = strcmp('hi',A{k}{1}.Properties.VariableNames);
...
if (Exist_lo(Exist_lo==1))
    plot      (x{1},ytheo{end},'--r','LineWidth',3)
