...
void gpuStep_explicit(DataArray& device1, DataArray& device2, InitialData& id, double chi_dx, double chi_ecm_dx, int iter, int time_iter)
{
	...
	kernelGrowA<<<blocks_adv, threads_adv>>>(device1.a, device2.a, device1.dt, id.s, id.ka);
	//kernelAleeA<<<blocks_adv, threads_adv>>>(device1.a, device2.a, device1.a_first, device1.dt, id.s, id.ka, time_iter);
    ...
    kernelGrowA<<<blocks_adv, threads_adv>>>(device2.a, device1.a, device1.dt, id.s, id.ka);
